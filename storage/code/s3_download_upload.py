...
def main():
    ...
    # l_local_folder_file_to_upload='E:/code/PYTHON_TRAINING/Python_AWS/retail_sales/bills.csv'
    # Test 1
    # upload_my_file(l_s3_bucket, l_s3_folder, l_local_folder_file_to_upload, l_file_name)
    # Test 2
    # upload_my_file(l_s3_bucket, l_s3_folder, l_local_folder_file_to_upload)

    download_s3_file(l_s3_bucket, l_s3_folder, "bills.csv","E:\\code\\PYTHON_TRAINING\\Python_AWS\\bills.csv")
    download_s3_file(l_s3_bucket, l_s3_folder, "bill_details.csv","E:\\code\\PYTHON_TRAINING\\Python_AWS\\bill_details.csv")
    download_s3_file(l_s3_bucket, l_s3_scripts_folder, "billing_db.sql","E:\\code\\PYTHON_TRAINING\\Python_AWS\\billing_db.sql")
